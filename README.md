...
* Main [Opt](https://glcdn.githack.com/monnef/ts-opt/-/raw/v2.5.2/doc/modules/opt.html) class
* [Module](https://glcdn.githack.com/monnef/ts-opt/-/raw/v2.5.2/doc/modules.html) (constructors and helper functions)
