...
* Main [Opt](https://glcdn.githack.com/monnef/ts-opt/-/raw/v2.3.0/doc/classes/opt.html) class
* [Module](https://glcdn.githack.com/monnef/ts-opt/-/raw/v2.3.0/doc/modules.html) (constructors and helper functions)
