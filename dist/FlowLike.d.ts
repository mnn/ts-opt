...
export interface ComposeFn {
    ...
    <I, A1, A2, A3, R>(f1: (_: A3) => R, f2: (_: A2) => A3, f3: (_: A1) => A2, f4: (_: I) => A1): (x: I) => R;
    <I, A1, A2, A3, A4, R>(f1: (_: A4) => R, f2: (_: A3) => A4, f3: (_: A2) => A3, f4: (_: A1) => A2, f5: (_: I) => A1): (x: I) => R;
    <I, A1, A2, A3, A4, A5, R>(f1: (_: A5) => R, f2: (_: A4) => A5, f3: (_: A3) => A4, f4: (_: A2) => A3, f5: (_: A1) => A2, f6: (_: I) => A1): (x: I) => R;
    <I, A1, A2, A3, A4, A5, A6, R>(f1: (_: A6) => R, f2: (_: A5) => A6, f3: (_: A4) => A5, f4: (_: A3) => A4, f5: (_: A2) => A3, f6: (_: A1) => A2, f7: (_: I) => A1): (x: I) => R;
    <I, A1, A2, A3, A4, A5, A6, A7, R>(f1: (_: A7) => R, f2: (_: A6) => A7, f3: (_: A5) => A6, f4: (_: A4) => A5, f5: (_: A3) => A4, f6: (_: A2) => A3, f7: (_: A1) => A2, f8: (_: I) => A1): (x: I) => R;
    <I, A1, A2, A3, A4, A5, A6, A7, A8, R>(f1: (_: A8) => R, f2: (_: A7) => A8, f3: (_: A6) => A7, f4: (_: A5) => A6, f5: (_: A4) => A5, f6: (_: A3) => A4, f7: (_: A2) => A3, f8: (_: A1) => A2, f9: (_: I) => A1): (x: I) => R;
    <I, A1, A2, A3, A4, A5, A6, A7, A8, A9, R>(f1: (_: A9) => R, f2: (_: A8) => A9, f3: (_: A7) => A8, f4: (_: A6) => A7, f5: (_: A5) => A6, f6: (_: A4) => A5, f7: (_: A3) => A4, f8: (_: A2) => A3, f9: (_: A1) => A2, f10: (_: I) => A1): (x: I) => R;
}
