...
exports.jestSnapshotSerializer = {
    serialize: function (val) { return val.toString(); },
    test: function (val) { return exports.isOpt(val); },
};
